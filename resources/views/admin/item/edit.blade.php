                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                {{ Form::open(array('route' => ['item.update',$row->id], 'class'=>'form-horizontal group-border stripped', 'method'=>'PUT', 'id'=>'form')) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <select name="type_id" class="form-control">
                                                ...
                                                <option value="{{$type->id}}"@if ($row->type_id == $type->id){{'selected="selected"'}}@endif>{{$type->name}}</option>
                                                @endforeach
                                            </select>
                                            <label class="help-block" for="type_id"></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="text" class="col-lg-2 col-md-3 control-label">价格</label>
                                        <div class="col-lg-10 col-md-9">
                                    ...
                                    <!-- End .form-group  -->
                                    <div class="form-group">
                                        <label for="text" class="col-lg-2 col-md-3 control-label">颜色</label>
                                        <div class="col-lg-10 col-md-9">
                                            <input type="text" name="color" class="form-control" value="{{$row->color}}">
                                            <label class="help-block" for="color"></label>
                                        </div>
                                    </div>
                                    <!-- End .form-group  -->
                                    <div class="form-group">
                                        <label for="text" class="col-lg-2 col-md-3 control-label">规格</label>
                                        <div class="col-lg-10 col-md-9">
                                            <input type="text" name="specification" class="form-control" value="{{$row->specification}}">
                                            <label class="help-block" for="specification"></label>
                                        </div>
                                    </div>
                                    <!-- End .form-group  -->
                                    <div class="form-group">
