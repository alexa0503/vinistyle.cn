                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                {{ Form::open(array('route' => ['questions.items.store',$question->id], 'class'=>'form-horizontal group-border stripped', 'id'=>'form')) }}
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            ...
                                            <input type="text" class="form-control"  disabled="disabled" value="{{$question->title}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            ...
                                            <a class="btn btn-default ml15" href="{{route("questions.items.index",[$question->id])}}">返回</a>
                                        </div>
                                    </div>
                                    <!-- End .form-group  -->
                                    {{ Form::close() }}
...
$(document).ready(function() {
    ...
    $('#form').ajaxForm({
        ...
        success: function() {
            ...
            location.href='{{route("questions.items.index",[$question->id])}}';
        },
        error: function(xhr){
